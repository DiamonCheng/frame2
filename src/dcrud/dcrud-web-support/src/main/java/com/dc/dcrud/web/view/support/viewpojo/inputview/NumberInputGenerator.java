 ...
 * @date 2018/9/18.
 */
public class NumberInputGenerator implements ViewGenerator {
    private com.dc.dcrud.web.view.support.viewpojo.inputview.NumberInput textInputAnnotation;
    private String path;
    private Class<?> root;
    ...
    public void configure(Annotation viewAnnotation) {
        this.textInputAnnotation = (com.dc.dcrud.web.view.support.viewpojo.inputview.NumberInput) viewAnnotation;
    }
    ...
    public Frame2View generate(Object data1, List<Field> fieldList, Object fieldData) {
        ...
        ((InputView) textInput.getInputs().get(0)).setType(InputView.Type.NUMBER);
        return textInput;
    }
}
