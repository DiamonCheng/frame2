    ...
    u.prototype.type = function () {
        ...
        u.prototype.view = function () {
            ...
            a.layout = "object" == typeof a.layout ? a.layout : ["prev", "page", "next"],
                a.count = 0 | a.count,
                a.curr = 0 | a.curr || 1,
                a.total1 = a.total1 ? a.total1 : '共',
                a.total2 = a.total2 ? a.total2 : '条',
                a.itemPage = a.itemPage ? a.itemPage : '条/页',
                a.to = a.to ? a.to : '到第',
                a.pageString = a.pageString ? a.pageString : '页',
                a.submit = a.submit ? a.submit : '确定',
            ...
            var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1
                ...
                count: '<span class="layui-laypage-count"> ' + a.total1 + a.count + a.total2 + " </span>",
                limit: function () {
                    var e = ['<span class="layui-laypage-limits"><select lay-ignore>'];
                    return layui.each(a.limits, function (t, n) {
                        e.push('<option value="' + n + '"' + (n === a.limit ? "selected" : "") + ">" + n + a.itemPage + " </option>")
                    }),
                    e.join("") + "</select></span>"
                }(),
                skip: function () {
                    return ['<span class="layui-laypage-skip">' + a.to, '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', a.pageString + '<button type="button" class="layui-laypage-btn">' + a.submit + '</button>', "</span>"].join("")
                }()
            };
    ...
    C.prototype = [],
        ...
        T.prototype.checkDate = function (e) {
            var t, a, i = this, r = (new Date,
                    i.config), o = r.dateTime = r.dateTime || i.systemDate(), s = i.bindElem || r.elem[0],
                l = (i.isInput(s) ? "val" : "html",
...
layui.define("layer", function (e) {
    ...
    var t = layui.$
        ...
        , p = function (e) {
        var i = this;
        i.config = t.extend({}, i.config, o.config, e),
            i.render()
    };
    p.prototype.config = {
        accept: "images",
        ...
        p.prototype.initIE = function () {
            ...
            i.elem.next().hasClass(f) || (e.elemFile.wrap(a),
                i.elem.next("." + f).append(function () {
                    var e = [];
        ...
        p.prototype.upload = function (e, i) {
            var n, o = this, l = o.config, r = o.elemFile[0], u = function () {
                ...
                return "choose" === i ? l.choose && l.choose(g) : (l.before && l.before(g),
    ...
    c.prototype.set = function (e) {
        ...
        c.prototype.render = function (e, i) {
            var n = this
                ...
                , d = {
                select: function () {
                    var e, i = "请选择", a = "layui-form-select", n = "layui-select-title", r = "layui-select-none",
                        d = "", f = c.find("select"), y = function (i, l) {
...
layui.define("jquery", function (e) {
    ...
    r.prototype.init = function (e) {
        ...
        r.prototype.spread = function (e, o) {
            var a = this
                , i = (a.options,
                e.children(".layui-tree-spread"))
                , r = e.children("ul")
                , n = e.children("a")
                , l = function () {
                e.data("spread") ? (e.data("spread", null),
                    r.removeClass("layui-show"),
                    i.html(t.arrow[0]),
                    n.find(".layui-icon").html(t.branch[0])) : (e.data("spread", !0),
                    ...
                    t.ajax({
                        ...
                        success: function (t) {
                            t[r.statusName] != r.statusCode ? (a.renderForm(),
                                a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t, e, t[r.countName]),
                                d(),
        ...
        M.prototype.renderData = function (e, n, o, r) {
            ...
            return c.key = s.id || s.index,
                ...
                r ? v() : 0 === u.length ? (c.renderForm(),
                    ...
                    c.layMain.find("." + f).remove(),
                    c.layMain.append('<div class="' + f + '">' + s.text.none + "</div>")) : (v(),
                ...
                a.layBody.on("click", "td", function () {
                    ...
                    if (l.close(a.tipsIndex),
                        ...
                        if (i)
                            ...
                            o.find(".layui-form-switch,.layui-form-checkbox")[0] || Math.round(o.prop("scrollWidth")) > Math.round(o.outerWidth()) && (a.tipsIndex = l.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (o.height() + 16) + "px;" + function () {
